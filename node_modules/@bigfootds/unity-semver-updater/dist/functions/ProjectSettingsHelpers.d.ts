...
export declare class ProjectSettingsHelpers {
    /**
     ...
     */
    static getExistingBundleVersion(targetFilePath: string, valueFormat?: string): Promise<UnityProjectVersion | null>;
    /**
     ...
     */
    static writeToProjectSettings(targetFilePath: string, targetPropertyCollection: PlayerSettingsVersionStrings, searchFormat?: string): Promise<boolean>;
}
